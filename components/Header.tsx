...
export function Header() {
  ...
  const ThemeBadge = (
    <a
      ...
      title="Tema HKBP 2024 sampai 2028: Transformasi, Roma 12:2"
      aria-label="Tema Transformasi HKBP 2024 sampai 2028"
    >
      <Image
        src="/theme-transformasi.webp"
        alt="Logo Tema Transformasi HKBP 2024 sampai 2028"
        width={44}
        height={44}
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3.5">
        <a
          ...
          aria-label="HKBP Glugur, Beranda"
        >
          <Image
            src="/hkbp-logo.webp"
